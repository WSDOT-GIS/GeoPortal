    ...
    $.fn.locationInfo = function (layerListUrl) {
        ...
        function createControl(data) {
            ...
            var units = [
                ...
                { "name": "Meter", "value": 9001, "description": "Meters" },
                { "name": "Kilometer", "value": 9036, "description": "Kilometers" },
                { "name": "Decimeter", "value": 109005, "description": "Decimeters" },
                { "name": "Centimeter", "value": 109006, "description": "Centimeters" },
                { "name": "Millimeter", "value": 109007, "description": "Millimeters" },
            ...
            */
            ...
            $.each(data, function (index, layer) {
                ...
                // nodes.checkbox.attr("data-layer", JSON.stringify(layer));
