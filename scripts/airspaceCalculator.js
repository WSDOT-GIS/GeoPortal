...
(function ($) {
	...
	////}
		...
		function formatResults(graphic) {
			...
			message = ["A structure ", graphic.attributes.AGL, "' above ground level ", graphic.attributes.PenetratesSurface === "yes" ? " would " : " would not ", " penetrate an airport's airspace."].join("");
