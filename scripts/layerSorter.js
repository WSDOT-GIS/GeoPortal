require(["geoportal/layerUtils"], function (layerUtils) {
    "use strict";
    ...
    $.widget("ui.layerSorter", {
        ...
        _populateList: function () {
            ...
            for (l = map.layerIds.length, i = l - 1; i >= 0; i -= 1) {
                ...
                $(['<li class="ui-state-default" title="', layer.description, '"><span class="ui-icon ui-icon-arrowthick-2-n-s"></span>', layerUtils.createLayerNameFromUrl(layer), '</li>'].join("")).data("layer", layer).appendTo(this._list);
            }
        },
        _refresh: function () {
