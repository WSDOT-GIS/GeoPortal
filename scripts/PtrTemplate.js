...
define(["esri/InfoTemplate"], function (InfoTemplate) {
    ...
    return new InfoTemplate({
        content: "${Site Location}<p><a href='https://www.wsdot.wa.gov/Traffic/API/PermanentTrafficRecorder/?siteId=${Site ID}' target='_blank'>Download CSV</a></p>", //createContent,
