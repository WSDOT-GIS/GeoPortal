...
/**
 * Creates a DocumentFragment containing options
 */
export function createCountyOptions() {
  const frag = document.createDocumentFragment();
  // Add blank option
  frag.appendChild(document.createElement("option"));
  for (const [id, name] of countyLookup) {
